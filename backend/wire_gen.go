...
import (
	"github.com/chenmingyong0423/fnote/backend/ineternal/category/handler"
	...
	"github.com/chenmingyong0423/fnote/backend/ineternal/comment/hanlder"
	repository2 "github.com/chenmingyong0423/fnote/backend/ineternal/comment/repository"
	dao2 "github.com/chenmingyong0423/fnote/backend/ineternal/comment/repository/dao"
	service2 "github.com/chenmingyong0423/fnote/backend/ineternal/comment/service"
	handler2 "github.com/chenmingyong0423/fnote/backend/ineternal/config/handler"
	repository3 "github.com/chenmingyong0423/fnote/backend/ineternal/config/repository"
	dao3 "github.com/chenmingyong0423/fnote/backend/ineternal/config/repository/dao"
	service3 "github.com/chenmingyong0423/fnote/backend/ineternal/config/service"
	service5 "github.com/chenmingyong0423/fnote/backend/ineternal/email/service"
	hanlder2 "github.com/chenmingyong0423/fnote/backend/ineternal/friend/hanlder"
	repository5 "github.com/chenmingyong0423/fnote/backend/ineternal/friend/repository"
	dao5 "github.com/chenmingyong0423/fnote/backend/ineternal/friend/repository/dao"
	service7 "github.com/chenmingyong0423/fnote/backend/ineternal/friend/service"
	service6 "github.com/chenmingyong0423/fnote/backend/ineternal/message/service"
	handler3 "github.com/chenmingyong0423/fnote/backend/ineternal/post/handler"
	...
	handler4 "github.com/chenmingyong0423/fnote/backend/ineternal/visit_log/handler"
	repository6 "github.com/chenmingyong0423/fnote/backend/ineternal/visit_log/repository"
	dao6 "github.com/chenmingyong0423/fnote/backend/ineternal/visit_log/repository/dao"
	service8 "github.com/chenmingyong0423/fnote/backend/ineternal/visit_log/service"
