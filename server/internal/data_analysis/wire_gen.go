...
func InitDataAnalysisModule(mongoDB *mongo.Database, vlServ service.IVisitLogService, csServ service2.ICountStatsService) *Module {
	dataAnalysisHandler := web.NewDataAnalysisHandler(vlServ, csServ)
	module := &Module{
