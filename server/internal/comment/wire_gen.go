...
func InitCommentModule(mongoDB *mongo.Database, msgServ service.IMessageService, statsServ service2.ICountStatsService, cfgModule *website_config.Module, postModule *post.Module) *Module {
