...
export async function generateMetadata({ params }: { params: { tag: string } }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description: `浏览${tagName}标签下的全部文章。`,
      url: process.env.BASE_HOST + `/tags/${params.tag}`,
...
export default async function TagPage({ params, searchParams }: { params: { tag: string }, searchParams: { filter?: string, pageSize?: string } }) {
