        ...
        <a :href="friend.url"
          ...
          <div class="w-15% flex justify-center">
            <img :src="friend.logo" alt=""
                 ...
                 v-if="friend.logo != ''">
            <div class="i-ph-user-circle-duotone w-full h-12 border-rounded-50%  lt-lg:mr0 text-gray-4" v-else></div>
          </div>
          <div class="w-74% ml-1%">
...
import {type IFriend, type FriendReq, getFriends, applyForFriend} from "~/api/friend";
