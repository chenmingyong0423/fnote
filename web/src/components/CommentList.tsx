...
export const CommentList: React.FC<CommentListProps & {
  ...
  return (
    <div className="divide-y divide-gray-100 dark:divide-gray-800">
      {comments.map((item) => (
        <div key={item.id} className="flex gap-2 md:gap-3 py-4">
          ...
          <div className="min-w-0 flex-1">
            ...
            <MarkdownPreview content={item.content} className="p-3 md:p-4" />
            {replying && replying.commentId === item.id && !replying.replyToId && (
            ...
            {item.replies && item.replies.length > 0 && (
              <div className="mt-3 divide-y divide-gray-100 dark:divide-gray-800">
                {item.replies.map((reply) => (
                  <div key={reply.id} className="flex gap-2 md:gap-3 py-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-1 break-words">{reply.content}</div>
