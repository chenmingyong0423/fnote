        ...
        <el-row :gutter="40">
            <el-col :span="18">
                <div class=" rounded-15 bg-#fff p30">
                    <!-- <v-md-preview :text="data2.data.content" height="400px"></v-md-preview> -->
...
const data2 = {
    ...
    "data": {
        "id": "go-maps",
        "author": "陈明勇",
        "title": "深入探索 Go 1.21.0 中的 maps 工具库",
        "summary": "本文对 Go 工具库 maps 进行详细介绍，包括其提供的函数 Clone、Copy、DeleteFunc、Equal 和 EqualFunc，并强调了使用这些函数时需要注意的地方。",
        ...
        "publishDate": "2023-08-17 02:36:49",
        "category": "后端",
        "columns": [
            "Go 标准库"
        ],
        "cover": "https://blog-1302954944.cos.ap-guangzhou.myqcloud.com/img/%E5%B0%81%E9%9D%A2-%E6%B7%B1%E5%85%A5%E6%8E%A2%E7%B4%A2%20Go%201.21.0%20%E4%B8%AD%E7%9A%84%20maps%20%E5%B7%A5%E5%85%B7%E5%BA%93.jpg",
        "likesCount": 1,
        "viewsCount": 60,
        "commentInfo": [],
        "isLike": false
