...
const items = reactive([
  ...
  },
  {
    ...
    children: [
      {
        key: '/admin/home/setting',
        label: '博客设置',
        title: '博客设置'
      },
      {
        key: '/admin/home/backup',
        label: '备份',
        title: '备份'
      }
    ]
